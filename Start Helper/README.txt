...
dotnet ef migrations add Initial --context Context --project BeautyStore.Data --startup-project BeautyStore

2. Применение
dotnet ef database update --context IdentityContext --project BeautyStore.Identity --startup-project BeautyStore
dotnet ef database update --context Context --project BeautyStore.Data --startup-project BeautyStore
