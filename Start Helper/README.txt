...
dotnet ef migrations add Initial --context Context --project BeautyStore.DAL --startup-project BeautyStore.App

2. Применение
dotnet ef database update --context IdentityContext --project BeautyStore.Identity --startup-project BeautyStore
dotnet ef database update --context Context --project BeautyStore.DAL --startup-project BeautyStore.App
